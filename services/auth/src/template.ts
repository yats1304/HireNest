...
button below to create a new password: 
                            ...
                            <!-- Button -->
                                <div class="button-wrapper">
                                    <a href="${resetLink}" 
                                    class="button"
                                    style="display:inline-block; padding:14px 40px; background-color:#7c3aed; color:#ffffff !important; text-decoration:none; border-radius:100px; font-weight:600; font-size:15px; letter-spacing:0.1px;">
                                        Reset Password
                                    </a>
                                </div>
