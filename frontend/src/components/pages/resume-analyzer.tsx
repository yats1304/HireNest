...
import { utils_service } from '@/config/services'
...
const ResumeAnalyzer = () => {
  ...
  const analyzeResume = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(`${utils_service}/api/utils/resume-analyzer`, {
        pdfBase64: base64,
      })
  ...
  return (
    <div className='max-w-7xl mx-auto px-4 py-16 bg-secondary/30'>
      <div className='text-center mb-12'>
        ...
        <h2 className='text-3xl md:text-4xl font-bold mb-4'>Optimize Your Resume for ATS</h2>
            ...
            {!response ? (
                  ...
                  >
                    <div className='flex flex-col items-center gap-4'>
                      ...
                      <div>
                        ...
                        <p className='text-sm opacity-60'>PDF format only, maximum 5MB</p>
                      </div>
              ...
              <>
                ...
                <div className='space-y-6 py-4'>
                  {/* Overall Score */}
                  <div className={`p-6 rounded-lg ${getScoreBgColor(response.atsScore)} border-2`}>
                    <div className='text-center'>
                      <p className='text-sm font-medium opacity-70 mb-2'>ATS Compatibility Score</p>
                      ...
                      {response.suggestions.map((suggestion, index) => (
                        <div key={index} className='p-4 rounded-lg border'>
                          ...
                          <div className='space-y-2 text-sm'>
                            <div>
                              <span className='font-medium opacity-70'>Issue: </span>
                              <span className='opacity-80'>{suggestion.issue}</span>
                            </div>

                            <div>
                              <span className='font-medium opacity-70'>Fix: </span>
                              <span className='opacity-80'>{suggestion.recommendation}</span>
                            </div>
                          </div>
                        </div>
                      ))}
