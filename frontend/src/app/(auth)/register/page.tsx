                ...
                <div className="space-y-5 animated-in fade-in duration-300">
                  ...
                  <div className='space-y-2'>
                    ...
                    <div className="relative">
                      ...
                      onChange={e=>setName(e.target.value)} required className='pl-10 h-11'/>
                    </div>
                  </div>
                  ...
                  <div className='space-y-2'>
                    ...
                    <div className="relative">
                      <Mail className='icon-style'/>
                      <Input id='phone' type='number' placeholder='+91 1234567890' value={phoneNumber}
                      onChange={e=>setPhoneNumber(e.target.value)} required className='pl-10 h-11'/>
                    </div>
                  </div>

                  {
                    ...
                    <div className="space-y-5 pt-4 border-t border-gray-400">
                      <div className='space-y-2'>
                        <Label htmlFor='resume' className='text-sm font-medium'>Phone (PDF)</Label>
                        <div className="relative">
                      ...
                      <div className='space-y-2'>
                        ...
                        <div className="relative">
                          <Mail className='icon-style'/>
                          <Input id='bio' type='text' placeholder='Tell me about yourself...' value={bio}
                          onChange={e=>setBio(e.target.value)} required className='pl-10 h-11'/>
                        </div>
                      </div>
                    </div>
                  }
